		...
		<header>
			<div class="container-fluid">
				<div class="container-fluid">
					...
					<a href="#3rdPage"><img src="{{url()}}/img/bar-toogle.png" alt="" class="img-responsive hashtag pull-right"></a>
				</div>
			</div>
		</header>
		<div id="fullpage" class="reto">
			<div class="section home" id="section0">
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<img src="{{url()}}/img/reto-mobile.png" alt="" class="img-responsive center-block">
						</div>
					</div>
				</div>
				<div class="pie-movil">
			...
			<div class="section home" id="section1">
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12">
							<img src="{{url()}}/img/kilos-parrafo.png" alt="" class="img-responsive center-block">
							<div class="kilos-reto">
								<img src="{{url()}}/img/back-8-kilos.png" alt="" class="img-responsive center-block">
								<p>
									8kgs  <span>de ayuda</span>
								</p>
							</div>
						</div>
					</div>
			...
			<div class="section home" id="section2">
				<div class="row">
					...
					<div class="col-xs-6 menu-mobile">
						<a href="#"><img src="{{url()}}/img/reto-menu-1.jpg" alt="" class="img-responsive center-block"></a>
						<a href="#"><img src="{{url()}}/img/reto-menu-2.jpg" alt="" class="img-responsive center-block activo"></a>
					</div>
					<div class="col-xs-6 menu-mobile">
